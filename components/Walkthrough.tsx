...
export const Walkthrough = ({ onComplete, mode = 'RESULTS' }: WalkthroughProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-center justify-center animate-fade-in p-4">
      <div className="bg-white w-full max-w-sm rounded-3xl shadow-2xl p-6 relative mx-4 border border-library-100">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          <div className="w-16 h-16 md:w-20 md:h-20 bg-library-50 rounded-full flex items-center justify-center mb-2 shadow-inner border border-library-100">
            {steps[step].icon}
          </div>
          <h3 className="text-2xl md:text-3xl font-serif font-bold text-library-900">{steps[step].title}</h3>
