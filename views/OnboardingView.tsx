...
export const OnboardingView = ({ onComplete, onAdminLogin }: { onComplete: () => void, onAdminLogin?: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-library-900/90 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] relative animate-scale-up">
        ...
        <div className="p-8 flex-1 overflow-y-auto">
          {step === 1 && (
            <div className="animate-fade-in space-y-6 flex flex-col h-full">
               ...
               <div className="space-y-3 mt-auto pt-6">
                  <button onClick={() => setStep(2)} disabled={!selectedUni} className="w-full bg-library-900 text-white py-4 rounded-xl font-bold text-lg hover:bg-library-800 transition-all disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer">Continue <ChevronRightIcon className="w-5 h-5" /></button>
          ...
          {step === 2 && (
            <div className="animate-fade-in space-y-6">
              <div className="text-center">
                 <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4 text-blue-600"><IdCardIcon className="w-8 h-8" /></div>
          ...
          {step === 3 && (
             <div className="animate-fade-in space-y-6">
                <div className="text-center">
                 <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 text-green-600"><UserIcon className="w-8 h-8" /></div>
